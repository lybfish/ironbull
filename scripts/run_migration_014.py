        ...
        if table_exists(conn, "dim_market_info", schema):
            ...
            conn.execute(text("""
                CREATE TABLE dim_market_info (
                    ...
                    min_quantity DECIMAL(30,10) DEFAULT NULL COMMENT '最小下单数量',
                    max_quantity DECIMAL(30,10) DEFAULT NULL COMMENT '最大下单数量',
                    min_cost DECIMAL(20,8) DEFAULT NULL COMMENT '最小下单金额 (USDT)',
                    min_price DECIMAL(30,10) DEFAULT NULL COMMENT '最小价格',
                    max_price DECIMAL(30,2) DEFAULT NULL COMMENT '最大价格',
